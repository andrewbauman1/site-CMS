...
export function PhotosClient({ initialPhotos, initialSha }: { initialPhotos: Photo[]; initialSha: string | null }) {
      ...
      {filteredAndSortedPhotos.length === 0 ? (
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {filteredAndSortedPhotos.map((photo) => (
            <Card key={photo.id} className="overflow-hidden photo-glow">
