...
export function StoriesClient({ initialStories, initialSha }: { initialStories: Story[]; initialSha: string | null }) {
      ...
      {filteredAndSortedStories.length === 0 ? (
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {filteredAndSortedStories.map((story) => (
            <Card key={story.id} className="overflow-hidden photo-glow">
